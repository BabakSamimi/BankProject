...
namespace BankProject
{
    class LoginView : View
    {
        ...
        private void LoginView_Load(object sender, EventArgs e)
        {
            ...
            userNameField.LostFocus += UserNameField_LostFocus;


        }

        private void UserNameField_LostFocus(object sender, EventArgs e)
        {
        ...
        private void UserNameField_GotFocus(object sender, EventArgs e)
        {
